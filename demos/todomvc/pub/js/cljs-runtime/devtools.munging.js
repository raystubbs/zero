...
var o28702 = temp__5802__auto__;
var temp__5802__auto____$1 = (o28702["core"]);
if(cljs.core.truth_(temp__5802__auto____$1)){
var o28703 = temp__5802__auto____$1;
return (o28703["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__28127__auto__ = f;
return (o__28127__auto__["toString"]).call(o__28127__auto__);
} else {
return "";
}
}catch (e28707){var _ = e28707;
return "";
}});
...
try{var o__28127__auto___29045 = t;
(o__28127__auto___29045["cljs$lang$ctorPrWriter"]).call(o__28127__auto___29045,t,writer);
}catch (e28718){var __29046 = e28718;
}
...
var char_code = (function (){var o__28127__auto__ = (new String(char$));
return (o__28127__auto__["charCodeAt"]).call(o__28127__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__28127__auto__ = String;
return (o__28127__auto__["fromCharCode"]).call(o__28127__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__28733 = num_code;
switch (G__28733) {
case (1):
return (185);
...
var o__28127__auto__ = String;
return (o__28127__auto__["fromCharCode"]).call(o__28127__auto__,superscript_code);
});
/**
...
}catch (e28752){var _e__28192__auto__ = e28752;
return false;
}})())){
...
var vec__28753 = devtools.munging.parse_fn_source(fn_source);
var name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28753,(0),null);
...
var len__5769__auto___29078 = arguments.length;
var i__5770__auto___29079 = (0);
while(true){
if((i__5770__auto___29079 < len__5769__auto___29078)){
args__5775__auto__.push((arguments[i__5770__auto___29079]));

var G__29082 = (i__5770__auto___29079 + (1));
i__5770__auto___29079 = G__29082;
continue;
} else {
}
break;
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__28764){
var vec__28765 = p__28764;
var ns_detector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28765,(0),null);
...
var G__29086 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last(remaining_tokens)], null),name_tokens);
var G__29087 = cljs.core.butlast(remaining_tokens);
name_tokens = G__29086;
remaining_tokens = G__29087;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq28762){
...
var vec__28774 = cljs.core.split_with((function (p1__28772_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__28772_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28774,(0),null);
var arity_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28774,(1),null);
...
var vec__28787 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(remaining_tokens,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([detector], 0));
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28787,(0),null);
var name_and_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28787,(1),null);
if(cljs.core.empty_QMARK_(protocol_ns)){
var G__29097 = cljs.core.rest(remaining_tokens);
var G__29098 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(name_tokens,cljs.core.first(remaining_tokens));
remaining_tokens = G__29097;
name_tokens = G__29098;
continue;
} else {
...
var vec__28801 = devtools.munging.strip_arity(tokens);
var tokens__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28801,(0),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28801,(1),null);
var vec__28804 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(tokens__$1,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([effective_detector], 0));
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28804,(0),null);
var tokens__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28804,(1),null);
var vec__28807 = devtools.munging.parse_protocol(tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28807,(0),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28807,(1),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28807,(2),null);
var protocol_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28807,(3),null);
...
var vec__28821 = result;
var munged_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28821,(0),null);
var munged_name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28821,(1),null);
var munged_protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28821,(2),null);
var munged_protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28821,(3),null);
var munged_protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28821,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28821,(5),null);
...
if(cljs.core.truth_(temp__5802__auto__)){
var vec__28824 = temp__5802__auto__;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28824,(0),null);
var args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28824,(1),null);
var vec__28827 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$1(munged_name);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28827,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28827,(1),null);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.take.cljs$core$IFn$_invoke$arity$2((2),fn_info),cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),(function (){var G__28840 = cljs.core.second(cljs.core.first(arities));
return (devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1 ? devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1(G__28840) : devtools.munging.parse_fn_info_deep.call(null,G__28840));
})()));
}
} else {
return fn_info;
...
var G__29122 = (arity + (1));
var G__29123 = (function (){var temp__5802__auto__ = devtools.munging.get_fn_fixed_arity(f,arity);
if(cljs.core.truth_(temp__5802__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__28859){
var vec__28860 = p__28859;
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28860,(0),null);
var arity_fn = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28860,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__28874_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(arities,p1__28874_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.cljs$core$IFn$_invoke$arity$2(devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__28875_SHARP_){
return cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),p1__28875_SHARP_);
}),sorted_infos);
...
var args__5775__auto__ = [];
var len__5769__auto___29141 = arguments.length;
var i__5770__auto___29142 = (0);
while(true){
if((i__5770__auto___29142 < len__5769__auto___29141)){
args__5775__auto__.push((arguments[i__5770__auto___29142]));

var G__29143 = (i__5770__auto___29142 + (1));
i__5770__auto___29142 = G__29143;
continue;
} else {
}
break;
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__28880){
var vec__28881 = p__28880;
var humanize_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28881,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq28877){
var G__28879 = cljs.core.first(seq28877);
var seq28877__$1 = cljs.core.next(seq28877);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__28879,seq28877__$1);
}));
...
var map__28900 = options;
var map__28900__$1 = cljs.core.__destructure_map(map__28900);
var include_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28900__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28900__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28900__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28900__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__28901 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$2(munged_name,ns_detector);
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28901,(0),null);
var fn_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28901,(1),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28901,(2),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28901,(3),null);
var protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28901,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28901,(5),null);
...
var o__28127__auto__ = f;
return (o__28127__auto__["getBasis"]).call(o__28127__auto__);
});
/**
...
}catch (e28922){var _e__28192__auto__ = e28922;
...
var G__29160 = (obj[cljs.core.first(path)]);
var G__29161 = cljs.core.rest(path);
obj = G__29160;
path = G__29161;
continue;
} else {
...
var _STAR_ = (function (accum,p__29002){
var vec__29004 = p__29002;
var bit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29004,(0),null);
var protocol = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29004,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__29019){
var vec__29020 = p__29019;
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29020,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29020,(1),null);
var selector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29020,(2),null);
...
var post_process = (function (p__29033){
var vec__29034 = p__29033;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29034,(0),null);
var matches__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29034,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__29030_SHARP_){
return (obj[cljs.core.first(p1__29030_SHARP_)]);
}),sorted_matches);
