...
var i_33602 = (0);
while(true){
if((i_33602 < arr.length)){
(arr[i_33602] = null);

var G__33603 = (i_33602 + (1));
i_33602 = G__33603;
continue;
} else {
}
...
var i_33614 = (self__.level + (1));
while(true){
if((i_33614 <= (new_level + (1)))){
(update[i_33614] = self__.header);
...
while(true){
if((i <= self__.level)){
var links_33618 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_33618[i]));
} else {
x__$2.forward.push((((i < links_33618.length))?(links_33618[i]):null));
}

if((i < links_33618.length)){
(links_33618[i] = x__$2);
} else {
links_33618.push(x__$2);
}
...
var i_33624 = (0);
while(true){
if((i_33624 <= self__.level)){
var links_33625 = (update[i_33624]).forward;
if((x__$1 === (((i_33624 < links_33625.length))?(links_33625[i_33624]):null))){
(links_33625[i_33624] = (x__$1.forward[i_33624]));

var G__33626 = (i_33624 + (1));
i_33624 = G__33626;
continue;
} else {
var G__33627 = (i_33624 + (1));
i_33624 = G__33627;
continue;
}
} else {
...
var G__33634 = nx;
var G__33635 = (level__$1 - (1));
x = G__33634;
level__$1 = G__33635;
continue;
} else {
var G__33636 = x;
var G__33637 = (level__$1 - (1));
x = G__33636;
level__$1 = G__33637;
continue;
}
...
if(cljs.core.truth_(nx)){
var G__33640 = nx;
var G__33641 = (level__$1 - (1));
x = G__33640;
level__$1 = G__33641;
continue;
} else {
var G__33642 = x;
var G__33643 = (level__$1 - (1));
x = G__33642;
level__$1 = G__33643;
continue;
}
